...
#define GEN7_ENTRY(op, min_len) { GEN7_MI_OPCODE_ ## op, min_len, GEN7_ ## op ## __SIZE, #op }
		GEN6_ENTRY(MI_NOOP, 1),
		GEN6_ENTRY(MI_BATCH_BUFFER_END, 1),
		GEN6_ENTRY(MI_STORE_DATA_IMM, 5),
		GEN6_ENTRY(MI_LOAD_REGISTER_IMM, 3),
		GEN6_ENTRY(MI_STORE_REGISTER_MEM, 3),
		GEN6_ENTRY(MI_FLUSH_DW, 4),
		GEN6_ENTRY(MI_REPORT_PERF_COUNT, 3),
		GEN7_ENTRY(MI_LOAD_REGISTER_MEM, 1),
...
#define GEN8_ENTRY(subtype, op, min_len) { GEN6_RENDER_SUBTYPE_ ## subtype, GEN8_RENDER_OPCODE_ ## op, min_len, GEN8_ ## op ## __SIZE, #op }
		...
		GEN6_ENTRY(3D, 3DSTATE_SAMPLE_MASK, 2),
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_CONSTANT_HS, 5, GEN6_3DSTATE_CONSTANT_ANY__SIZE, "3DSTATE_CONSTANT_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_CONSTANT_DS, 5, GEN6_3DSTATE_CONSTANT_ANY__SIZE, "3DSTATE_CONSTANT_ANY" },
		GEN7_ENTRY(3D, 3DSTATE_HS, 1),
		GEN7_ENTRY(3D, 3DSTATE_TE, 1),
		GEN7_ENTRY(3D, 3DSTATE_DS, 1),
		GEN7_ENTRY(3D, 3DSTATE_STREAMOUT, 1),
		GEN7_ENTRY(3D, 3DSTATE_SBE, 1),
		GEN7_ENTRY(3D, 3DSTATE_PS, 1),
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_VIEWPORT_STATE_POINTERS_SF_CLIP, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_VIEWPORT_STATE_POINTERS_CC, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BLEND_STATE_POINTERS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_DEPTH_STENCIL_STATE_POINTERS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BINDING_TABLE_POINTERS_VS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BINDING_TABLE_POINTERS_HS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BINDING_TABLE_POINTERS_DS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BINDING_TABLE_POINTERS_GS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_BINDING_TABLE_POINTERS_PS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_SAMPLER_STATE_POINTERS_VS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_SAMPLER_STATE_POINTERS_HS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_SAMPLER_STATE_POINTERS_DS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_SAMPLER_STATE_POINTERS_GS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_SAMPLER_STATE_POINTERS_PS, 2, GEN7_3DSTATE_POINTERS_ANY__SIZE, "3DSTATE_POINTERS_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_URB_VS, 2, GEN7_3DSTATE_URB_ANY__SIZE, "3DSTATE_URB_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_URB_HS, 2, GEN7_3DSTATE_URB_ANY__SIZE, "3DSTATE_URB_ANY" },
		...
		GEN6_ENTRY(3D, 3DSTATE_AA_LINE_PARAMETERS, 3),
		GEN6_ENTRY(3D, 3DSTATE_GS_SVB_INDEX, 4),
		GEN6_ENTRY(3D, 3DSTATE_MULTISAMPLE, 3),
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_PUSH_CONSTANT_ALLOC_VS, 2, GEN7_3DSTATE_PUSH_CONSTANT_ALLOC_ANY__SIZE, "3DSTATE_PUSH_CONSTANT_ALLOC_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_PUSH_CONSTANT_ALLOC_HS, 2, GEN7_3DSTATE_PUSH_CONSTANT_ALLOC_ANY__SIZE, "3DSTATE_PUSH_CONSTANT_ALLOC_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_PUSH_CONSTANT_ALLOC_DS, 2, GEN7_3DSTATE_PUSH_CONSTANT_ALLOC_ANY__SIZE, "3DSTATE_PUSH_CONSTANT_ALLOC_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_PUSH_CONSTANT_ALLOC_GS, 2, GEN7_3DSTATE_PUSH_CONSTANT_ALLOC_ANY__SIZE, "3DSTATE_PUSH_CONSTANT_ALLOC_ANY" },
		{ GEN6_RENDER_SUBTYPE_3D, GEN7_RENDER_OPCODE_3DSTATE_PUSH_CONSTANT_ALLOC_PS, 2, GEN7_3DSTATE_PUSH_CONSTANT_ALLOC_ANY__SIZE, "3DSTATE_PUSH_CONSTANT_ALLOC_ANY" },
		GEN7_ENTRY(3D, 3DSTATE_SO_DECL_LIST, 1),
